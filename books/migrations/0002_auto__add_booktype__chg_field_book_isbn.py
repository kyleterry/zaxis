...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('books_booktype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('books', ['BookType'])

        # Adding M2M table for field book_type on 'Book'
        db.create_table('books_book_book_type', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('book', models.ForeignKey(orm['books.book'], null=False)),
            ('booktype', models.ForeignKey(orm['books.booktype'], null=False))
        ))
        db.create_unique('books_book_book_type', ['book_id', 'booktype_id'])

        # Changing field 'Book.isbn'
        db.alter_column('books_book', 'isbn', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Deleting model 'BookType'
        db.delete_table('books_booktype')

        # Removing M2M table for field book_type on 'Book'
        db.delete_table('books_book_book_type')
    ...
    models = {
        ...
        'books.book': {
            ...
            'book_type': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['books.BookType']", 'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'edition': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'isbn': ('django.db.models.fields.CharField', [], {'default': "'0'", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
